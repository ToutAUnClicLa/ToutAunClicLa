export default {
  services: {
    ...
    card: {
      ...
      subservices: "Available services"
    },
    categories: {
      lawyers: {
        title: "Legal Services",
        description: "Expert legal advice on immigration, corporate law, and civil law.",
        short: "Legal"
      },
      health: {
      ...
      accounting: {
        ...
        description: "Tax and accounting management for individuals and businesses.",
        short: "Accounting"
      },
      finance: {
        title: "Financial Services",
        description: "Financial planning, insurance, and investments for your future."
      },
      realestate: {
        title: "Real Estate",
        description: "Buying, selling, and renting properties with expert advice."
      },
      cars: {
        title: "Automotive",
        description: "Vehicle sales, repair, and maintenance."
      },
      beauty: {
    ...
    cta: {
      ...
      description: "Join our network and connect with thousands of potential clients in the Latino community.",
      notifyButton: "Join the network",
  ...
  landing: {
    ...
    search: {
      ...
      placeholder: "Search dishes, restaurants, boutique...",
      button: "Search",
    ...
    serviceHighlights: [
      {
        ...
        icon: "health",
        cta: "Notify me when open",
        languages: ["Spanish", "English", "French"]
      },
      {
        id: 2,
        name: "Legal Services",
        description: "Lawyers specialized in immigration, business law, and accidents for the Latin community.",
        subservices: ["Immigration", "Business", "Accidents"],
        color: "from-indigo-600 to-blue-600",
        badge: "In selection",
      ...
      },
      {
        id: 3,
        name: "Accounting",
        description: "Accountants and tax advisors for workers, families, and entrepreneurs in Canada.",
        subservices: ["Tax returns", "Payroll", "Compliance"],
      ...
      },
      {
        ...
        description: "Financial planning, investments, and insurance with experts who understand your goals in Canada.",
        subservices: ["Investments", "Insurance", "Planning"],
      ...
      },
      {
        ...
        description: "Agents who help you buy, sell, or rent with transparent support.",
        subservices: ["Buy", "Rent", "Commercial"],
      ...
      },
      {
        ...
        description: "Secure and fast money transfers to support your family from Canada.",
        subservices: ["Remittances", "Transfers", "Currency exchange"],
      ...
      },
      {
        id: 7,
        name: "Car Advisors",
        description: "Buying, selling, and financing vehicles with transparent guidance.",
        subservices: ["Buy", "Sell", "Financing"],
      ...
      },
      {
        ...
        description: "Barbers, stylists, and manicurists close to you.",
        subservices: ["Barbers", "Stylists", "Manicurists"],
      ...
      },
      {
        id: 9,
        name: "Translators",
        description: "Certified translators for official documents and procedures.",
        subservices: ["Official", "Interpretation", "Documents"],
        color: "from-slate-700 to-emerald-600",
        badge: "Fast response",
        href: "/servicios#traductores",
        icon: "translation",
  ...
  servicesPage: {
    ...
    heroSubtitle: "Lawyers, doctors, accountants, advisors, translators and more bilingual experts for the Latin community in Montreal.",
    heroBadge: "Available very soon",
    heroCta: "Meet the professionals",
    comingSoon: "Launching very soon",
    description: "Connect with trusted legal, medical, financial, real estate, automotive, and translation specialists who speak your language and understand your culture.",
    highlightsTitle: "Featured professions",
    highlightsSubtitle: "Choose the category you need and we will notify you as soon as agendas open.",
    contactTitle: "Need another professional?",
    contactDescription: "Tell us your case and we will connect you with the right expert or open the category.",
  ...
  aboutUs: {
    ...
    mission: {
      title: "Our Mission",
      description: "To facilitate access to authentic Latin American products in Montreal, maintaining the quality, tradition and flavors that connect us with our roots."
    },
    story: {
      title: "Our Story",
      description: "ToutAunClicLa was born from the shared dream of three Latin entrepreneurs: two Colombians and one Venezuelan united by their passion for bringing authentic Latin American flavors to Montreal families. Every product in our store tells a story of tradition, quality, and love for our roots.",
      mission: "Our mission is to connect Latin families with the products they love, keeping alive the culinary and cultural tradition that defines us as a community in Montreal.",
      introduction: "ToutAunClicLa was born from the meeting of three passionate entrepreneurs:",
      founders: {
        title: "Our Founders",
        description: "Two talented Colombians and a Venezuelan entrepreneur who share a common vision: bringing the best of Latin America to Montreal.",
        colombia: "Representing Colombia's diversity and richness",
        venezuela: "Contributing Venezuelan warmth and flavor"
      },
      journey: {
        title: "Our Journey",
        paragraph1: "We arrived in Montreal with our traditions, family recipes and the desire to share the authentic flavors that define us as Latinos.",
        paragraph2: "We understand the nostalgia of being away from home and the importance of finding those products that connect us with our roots.",
        paragraph3: "Each product in our catalog is carefully selected, guaranteeing the authenticity and quality our customers deserve."
      }
    },
    values: {
      title: "Our Values",
      ...
      service: {
        title: "Service",
        description: "We provide an exceptional experience to every customer"
      }
    },
    location: {
      title: "Our Location",
      subtitle: "Serving the Greater Montreal Area",
      address: "620 Rue Saint-Thomas, Longueuil, QC J4H 3A7",
      serviceArea: "We deliver throughout the Montreal metropolitan area",
      commitment: "We are committed to providing the best service to our local community."
    },
    team: {
      title: "Our Team",
      description: "A multicultural team united by the passion of sharing the best of Latin America",
      colombianFounders: "Colombian Founders",
      venezuelanFounder: "Venezuelan Founder",
  ...
  pro: {
    ...
    card: {
      ...
      notFoundText: "This card does not exist or is no longer online.",
      unavailableTitle: "Card available with Pro",
      unavailableText: "This professional is on the free plan. Public digital cards are included with Pro and Max.",
      unavailableCta: "See the plans",
    ...
    landing: {
      ...
      features: {
        ...
        subtitle: "Built for professionals, not for Silicon Valley.",
      ...
      finalCta: {
        ...
        subtitle: "Join the professionals who share differently.",
        ctaPrimary: "Create my account",
        ctaSecondary: "See the plans"
      },
      footer: {
        tagline: "The professional card for professionals.",
        plans: "Plans",
        signIn: "Sign in",
        privacy: "Privacy policy",
        terms: "Terms",
    ...
    auth: {
      ...
      register: {
        ...
        exists: "A professional account already exists with this email.",
      ...
      forgotPassword: {
        ...
        subtitle: "Enter your email. If an account is associated with it, you'll receive a code to reset your password.",
        emailLabel: "Email",
        emailPlaceholder: "name@example.com",
        submit: "Send code",
        backToLogin: "Back to sign in",
        success: "If an account exists with this email, you'll receive a code.",
        socialHint: "Sign in with Google instead.",
      ...
      resetPassword: {
        ...
        invalidCodeFormat: "The code must have 6 digits.",
    ...
    dashboard: {
      ...
      accountCardDesc: "Manage your account and, if needed, delete it.",
      account: {
        back: "Dashboard",
        title: "Account",
        subtitle: "Manage your professional account settings.",
        credentialsTitle: "Email and password",
        emailLabel: "Email",
        currentPasswordLabel: "Current password",
        newPasswordLabel: "New password",
        confirmPasswordLabelChange: "Confirm new password",
        ...
        socialHint: "This account uses Google. There is no password to change.",
        dangerZoneTitle: "Danger zone",
        dangerZoneText: "Deleting your account is irreversible and will erase your professional presence.",
        deleteButton: "Delete account",
        modalTitle: "Delete your account?",
        itemProfile: "Your public profile",
        itemSocials: "Your social networks",
        itemStats: "Your stats and analytics",
        itemSubscription: "Your active subscription (will be cancelled in Stripe)",
        itemGallery: "Your gallery",
        irreversible: "This action cannot be undone.",
        confirmPasswordLabel: "Current password",
        confirmEmailLabel: "Type your email to confirm",
        confirmEmailPlaceholder: "name@example.com",
        cancel: "Cancel",
        confirmDelete: "Yes, delete my account",
        deleteSuccess: "Account deleted successfully.",
        deleteError: "Could not delete the account. Try again or contact support.",
        invalidPassword: "Incorrect password.",
        confirmationMismatch: "The email doesn't match.",
        stripeError: "Could not process your subscription cancellation. Try again or contact support."
      },
      profile: {
    ...
    avatar: {
      change: "Change photo",
      hint: "This photo appears on your public card and in the directory. Use a vertical photo (4:5 ratio) so it shows in full, without cropping. JPG or PNG, 5 MB max.",
