export default {
  ...
  landing: {
    ...
    search: {
      ...
      placeholder: "Rechercher plats, restaurants, boutique...",
      button: "Rechercher",
    ...
    sections: {
      ...
      testimonials: {
        ...
        description: "De vraies commandes — restaurants, souvenirs et services à Montréal et sur la Rive-Sud."
      }
    },
    testimonials: [
      { quote: "J'ai commandé des arepas un vendredi : elles sont arrivées chaudes à Longueuil. Ça goûte Caracas, pas la « fusion ».", name: "Mariana López", place: "Longueuil", kind: "Restaurants" },
      { quote: "Le pabellón du dimanche, c'est celui de ma tante. On ne traverse plus le pont juste pour ça.", name: "Carlos Herrera", place: "Brossard", kind: "Restaurants" },
      { quote: "Des tamales pour 12, à l'heure pour l'anniversaire. Zéro stress.", name: "Ana Ruiz", place: "Saint-Hubert", kind: "Restaurants" },
      { quote: "Les empanadas salteñas étaient croustillantes. Le bureau du centre-ville a commandé le même menu.", name: "Diego Fernández", place: "Ville-Marie", kind: "Restaurants" },
      { quote: "Ceviche frais un jeudi soir. Je ne pensais pas pouvoir commander ça à Montréal.", name: "Lucía Mendoza", place: "Plateau", kind: "Restaurants" },
      { quote: "Un mate et un poncho pour ma sœur à Laval. Emballé, pas dans un sac générique.", name: "Sofía Álvarez", place: "Laval", kind: "Souvenirs" },
      { quote: "Les molas et le café-souvenir : le cadeau de Noël. Ce n'est pas du merch d'aéroport.", name: "Pierre Gagnon", place: "Boucherville", kind: "Souvenirs" },
      { quote: "Je cherchais un petit hamac et de l'artisanat du Guatemala. Trouvé ici, sans bazar.", name: "Elena Castro", place: "Chambly", kind: "Souvenirs" },
      { quote: "Un aimant et un chemisier brodé pour une collègue qui déménage. On voit le fait main.", name: "Nadia Benali", place: "Saint-Bruno", kind: "Souvenirs" },
      { quote: "Le dentiste bilingue m'a expliqué le devis en espagnol. Ça n'arrive pas partout.", name: "Jorge Ramírez", place: "LaSalle", kind: "Services" },
      { quote: "Un comptable qui comprend les T4 et les transferts. Impôts faits sans traduire dans l'auto.", name: "Valentina Soto", place: "Verdun", kind: "Services" },
      { quote: "Notaire pour le bail : un appel, le PDF le lendemain. Sans manquer le rendez-vous à la clinique.", name: "Andrés Peña", place: "Greenfield Park", kind: "Services" },
      { quote: "Traduction certifiée de l'acte de naissance en 48 h. Immigration ne l'a pas refusée.", name: "Camila Ortega", place: "Saint-Lambert", kind: "Services" },
      { quote: "Avocate en immigration qui répondait dans la langue de ma mère. Voilà pourquoi l'annuaire existe.", name: "Ricardo Núñez", place: "Hochelaga", kind: "Services" }
    ],
    productCategories: [
      {
        id: 1,
    ...
    serviceHighlights: [
      {
        ...
        icon: "health",
        cta: "Prévenez-moi à l’ouverture",
        languages: ["Espagnol", "Anglais", "Français"]
      },
      {
        id: 2,
        name: "Services juridiques",
        description: "Avocats spécialisés en immigration, droit des affaires et accidents pour la communauté latine.",
        subservices: ["Immigration", "Entreprises", "Accidents"],
        color: "from-indigo-600 to-blue-600",
        badge: "En sélection",
      ...
      },
      {
        id: 3,
        name: "Comptables",
        description: "Comptables et conseillers fiscaux pour travailleurs, familles et entrepreneurs au Canada.",
        subservices: ["Déclarations", "Paie", "Impôts"],
        color: "from-purple-600 to-fuchsia-600",
        badge: "Bientôt",
        href: "/servicios#contables",
        icon: "accounting",
        cta: "Prévenir au lancement",
        languages: ["Espagnol", "Anglais", "Français"]
      },
      {
        id: 4,
        name: "Conseillers financiers",
        description: "Planification financière, investissements et assurances avec des experts qui comprennent vos objectifs au Canada.",
        subservices: ["Investissements", "Assurances", "Planification"],
        color: "from-emerald-500 to-teal-500",
        badge: "Disponible bientôt",
        href: "/servicios#asesores-financieros",
        icon: "finance",
      ...
      {
        id: 5,
        name: "Conseillers immobiliers",
        description: "Courtiers qui vous aident à acheter, vendre ou louer avec un accompagnement transparent.",
        subservices: ["Achat", "Location", "Commercial"],
        color: "from-green-600 to-lime-500",
        badge: "Actif",
        href: "/servicios#asesores-inmobiliarios",
        icon: "realEstate",
      ...
      },
      {
        ...
        description: "Envois d’argent sécurisés et rapides pour soutenir votre famille depuis le Canada.",
        subservices: ["Envois", "Transferts", "Change"],
        color: "from-cyan-600 to-sky-500",
        badge: "Disponible",
        href: "/servicios#giros-internacionales",
        icon: "remittances",
        cta: "Programmer un envoi",
        languages: ["Espagnol", "Anglais", "Français"]
      },
      {
        id: 7,
        name: "Conseillers automobiles",
        description: "Achat, vente et financement de véhicules avec accompagnement transparent.",
        subservices: ["Achat", "Vente", "Financement"],
        color: "from-amber-500 to-orange-500",
        badge: "Nouveau",
        href: "/servicios#asesores-carros",
        icon: "auto",
        cta: "Recevoir des options",
        languages: ["Espagnol", "Anglais", "Français"]
      },
      {
        id: 8,
        name: "Services de beauté",
        description: "Barbiers, stylistes et manucures latinos près de chez vous.",
        subservices: ["Barbiers", "Stylistes", "Manucures"],
        color: "from-rose-500 to-pink-500",
        badge: "Sur rendez-vous",
        href: "/servicios#servicios-belleza",
        icon: "beauty",
      ...
      },
      {
        id: 9,
        name: "Traducteurs",
        description: "Traducteurs certifiés pour documents officiels et démarches.",
        subservices: ["Officiels", "Interprétation", "Documents"],
        color: "from-slate-700 to-emerald-600",
        badge: "Réponse rapide",
        href: "/servicios#traducteurs",
        icon: "translation",
  ...
  cart: {
    ...
    shipping: "expédition",
    freeShipping: "Promotion Gratuite",
  ...
  catalog: {
    ...
    restaurantBanner: {
      ...
      backToRestaurants: "Retour aux Cuisine"
    },
    // ProductCard
    productCard: {
      ...
      featured: "En vedette",
      weekendsOnly: "Samedis - Dimanches"
    },
    ...
    variations: {
      ...
      customizationAvailable: "Personnalisation disponible",
      clickToCustomize: "Cliquer pour personnaliser ce produit",
      selectAllRequired: "Sélectionner toutes les options requises",
      requiredGroup: "Requis",
      selectOption: "Sélectionner une option",
      selectOptions: "Sélectionner {min} à {max} options",
      ...
      validSelection: "Sélection valide",
      invalidSelection: "Sélection incomplète",
      stockInsufficient: "Stock insuffisant pour {name}",
      defaultOption: "Par défaut",
      outOfStock: "En rupture",
      onlyXAvailable: "Seulement {stock} disponibles",
      priceModifier: {
        add: "Ajouter {price}",
        subtract: "Remise {price}",
        free: "Gratuit"
      },
      groupTypes: {
        single: "Sélectionner une option",
        multiple: "Sélectionner plusieurs options"
      },
      validation: {
        requiredGroupMissing: "Ce groupe est requis",
    ...
    productList: {
      ...
      benefits: {
        fastDelivery: {
          ...
          description: "Recevez votre commande en 1h environ"
        },
        qualityGuarantee: {
    ...
    restaurantList: {
      ...
      comingSoon: "Disponible très bientôt",
      rating: "note",
  ...
  servicesPage: {
    heroTitle: "Services professionnels en un clic",
    heroSubtitle: "Avocats, médecins, comptables, conseillers, traducteurs et plus d’experts bilingues pour la communauté latine de Montréal.",
    heroBadge: "Disponibles très bientôt",
    heroCta: "Découvrir les professionnels",
    comingSoon: "Lancement très bientôt",
    description: "Connectez-vous avec des spécialistes juridiques, médicaux, financiers, immobiliers, automobiles et de traduction qui parlent votre langue et comprennent votre culture.",
    highlightsTitle: "Professions mises en avant",
    highlightsSubtitle: "Choisissez la catégorie dont vous avez besoin et nous vous informerons dès l’ouverture des agendas.",
    contactTitle: "Besoin d’un autre professionnel ?",
    contactDescription: "Expliquez-nous votre besoin et nous vous mettrons en relation avec l’expert approprié ou ouvrirons la catégorie.",
  ...
  aboutUs: {
    ...
    pageSubtitle: "Nous connectons les cultures, apportant les traditions latino-américaines à votre foyer à Montréal",
    hero: {
    ...
    ourStory: {
      ...
      description1: "Nous sommes trois entrepreneurs passionnés unis par l'amour de nos traditions et le désir de partager la richesse culturelle de l'Amérique latine avec les familles de Montréal.",
      description2: "Notre mission est d'être le pont qui relie les familles latino-américaines à leurs racines, en offrant des produits authentiques qui éveillent des souvenirs et créent de nouveaux moments autour de la table."
    },
    founders: {
      ...
      zenen1: {
        ...
        description: "Leader axé sur la connexion des cultures à travers des produits authentiques"
      },
      david: {
        name: "David Araujo Lopez",
        role: "Vice-président - Co-fondateur",
        description: "Spécialiste des opérations et de l'expérience client"
      },
      zenen2: {
        name: "Zenen Contreras Royero",
        role: "Technologie - Co-fondateur",
        description: "Expert en développement technologique et innovation numérique"
      }
    },
    mission: {
      title: "Notre Mission",
    ...
    values: {
      title: "Nos Valeurs",
      subtitle: "Les principes qui guident chaque décision et nous connectent à notre communauté",
      passion: {
        title: "Passion",
        description: "Amour pour notre culture et nos produits authentiques"
      },
      community: {
        title: "Communauté",
        description: "Nous connectons les familles à leurs traditions"
      },
      quality: {
        title: "Qualité",
        description: "Seulement les meilleurs produits latino-américains"
      },
      diversity: {
        title: "Diversité",
        description: "Nous célébrons la richesse culturelle de l'Amérique latine"
      },
      authenticity: {
        title: "Authenticité",
    ...
    contact: {
      ...
      description: "Nous sommes là pour vous aider. Contactez-nous pour toute demande ou suivez-nous sur les réseaux sociaux",
      ...
      addressLine3: "Montréal, Canada",
      getInTouch: "Prenez contact",
      followJourney: "Suivez notre parcours et découvrez de nouveaux produits chaque semaine.",
      contactInfo: "Informations de Contact",
      followUs: "Suivez-nous",
      followDescription: "Restez connecté avec nos dernières nouvelles et produits",
      addressLabel: "Adresse",
      emailLabel: "Courriel"
    },
    cta: {
      title: "Prêt à découvrir nos produits?",
      subtitle: "Explorez notre sélection de produits authentiques latino-américains et reconnectez avec vos traditions",
      ...
      viewFoods: "Voir la nourriture",
      visitBoutique: "Voir la boutique",
  ...
  pro: {
    ...
    landing: {
      ...
      card: {
        ...
        qrAlt: "Code QR vers la page d'inscription"
      },
      trust: {
    ...
    auth: {
      login: {
        title: "Connexion",
        subtitle: "Accède à ton tableau de bord professionnel.",
        emailLabel: "Courriel",
      ...
      register: {
        ...
        subtitle: "Lance ta présence professionnelle.",
      ...
      verify: {
        ...
        subtitlePrefix: "Saisis le code à 6 chiffres envoyé à",
        subtitleFallback: "ton courriel",
        codeLabel: "Code",
        submit: "Vérifier",
        ...
        resendError: "Renvoi impossible."
      },
      forgotPassword: {
        title: "Mot de passe oublié ?",
        subtitle: "Saisis ton courriel. Si un compte y est associé, tu recevras un code pour réinitialiser ton mot de passe.",
        emailLabel: "Courriel",
        emailPlaceholder: "nom@exemple.com",
        submit: "Envoyer le code",
        backToLogin: "Retour à la connexion",
        success: "Si un compte existe avec ce courriel, tu recevras un code.",
        socialHint: "Connecte-toi plutôt avec Google.",
      ...
      resetPassword: {
        ...
        invalidCodeFormat: "Le code doit contenir 6 chiffres.",
        ...
        requestNew: "Demander un nouveau code",
    ...
    dashboard: {
      ...
      accountCardDesc: "Gère ton compte et, si besoin, supprime-le.",
      account: {
        ...
        modalTitle: "Supprimer ton compte ?",
        itemProfile: "Ton profil public",
        itemSocials: "Tes réseaux sociaux",
        itemStats: "Tes statistiques et analyses",
        itemSubscription: "Ton abonnement actif (sera annulé sur Stripe)",
        itemGallery: "Ta galerie",
        irreversible: "Cette action est irréversible.",
        confirmPasswordLabel: "Mot de passe actuel",
        confirmEmailLabel: "Saisis ton courriel pour confirmer",
        confirmEmailPlaceholder: "nom@exemple.com",
        cancel: "Annuler",
        confirmDelete: "Oui, supprimer mon compte",
        deleteSuccess: "Compte supprimé avec succès.",
        deleteError: "Impossible de supprimer le compte. Réessaie ou contacte le support.",
        invalidPassword: "Mot de passe incorrect.",
        confirmationMismatch: "Le courriel ne correspond pas.",
        stripeError: "Impossible de traiter l'annulation de ton abonnement. Réessaie ou contacte le support."
      },
      profile: {
    ...
    pricingPage: {
      metaTitle: "Plans",
      metaDescription: "Commence gratuitement et passe à Pro ou Max quand tu veux. Essai de 7 jours sur les plans payants.",
      back: "Accueil",
      ...
      plans: {
        free: {
          name: "Free",
          description: "Pour commencer à apparaître.",
          f1: "Fiche de base dans l'annuaire",
          f2: "Nom et catégorie visibles"
        },
        pro: {
          name: "Pro",
          description: "Ta carte numérique complète.",
          f1: "Carte numérique + Apple Wallet et AirDrop",
          f2: "Profil public avec URL unique",
          f3: "Jusqu'à 5 réseaux sociaux",
          f4: "vCard téléchargeable",
          f5: "Fiche standard avec photo",
          f6: "Statistiques de base"
        },
        max: {
          name: "Max",
          description: "Visibilité et outils au maximum.",
          f1: "Tout ce qu'inclut Pro",
    ...
    profileForm: {
      ...
      titleBioHeading: "Titre et biographie",
      titleBioHint: "Remplis au moins ta langue principale. Les autres s'affichent selon le visiteur.",
      titleLabel: "Titre ({lang})",
      titlePlaceholderFr: "Courtière immobilière",
      titlePlaceholder: "Ton titre professionnel",
      bioLabel: "Biographie ({lang})",
      bioPlaceholder: "Explique à tes clients qui tu es et ce que tu offres.",
      primaryLangLabel: "Langue principale (par défaut)",
      categoryHeading: "Catégorie",
      categoryLabel: "Catégorie",
      subcategoryLabel: "Sous-catégorie",
      selectPlaceholder: "Sélectionne…",
      subcategoryPlaceholder: "Choisis une catégorie",
      spokenHeading: "Langues que tu parles",
      spokenHint: "Tes clients pourront filtrer par langue dans l'annuaire.",
    ...
    avatar: {
      ...
      hint: "Cette photo apparaît sur ta carte publique et dans l'annuaire. Utilise une photo verticale (proportion 4:5) pour qu'elle s'affiche en entier, sans recadrage. JPG ou PNG, 5 Mo maximum.",
      invalidType: "Sélectionne une image.",
      uploaded: "Photo mise à jour.",
      uploadError: "Téléversement de la photo impossible."
    },
    social: {
      loading: "Chargement…",
      ...
      remove: "Supprimer",
      added: "Réseau ajouté.",
      addError: "Ajout impossible (limite du plan ?).",
