export default {
  services: {
    ...
    grid: {
      ...
      subtitle: "Una selección de profesionales listos para ayudarte."
    },
    card: {
  ...
  landing: {
    hero: {
      ...
      description: "Restaurantes, servicios profesionales y souvenirs en Montreal y la Rive-Sud. Pide comida, encuentra un profesional o elige un recuerdo.",
    ...
    serviceHighlights: [
      ...
      },
      {
        ...
        description: "Abogados especializados en inmigración, derecho empresarial y accidentes para la comunidad latina.",
        subservices: ["Inmigración", "Empresas", "Accidentes"],
        color: "from-indigo-600 to-blue-600",
        badge: "En selección",
      ...
      },
      {
        id: 3,
        name: "Contables",
        description: "Contadores y asesores fiscales para trabajadores, familias y emprendedores en Canadá.",
        subservices: ["Declaraciones", "Nómina", "Impuestos"],
      ...
      },
      {
        ...
        description: "Planeación financiera, inversiones y seguros con expertos que entienden tus objetivos en Canadá.",
        subservices: ["Inversiones", "Seguros", "Planificación"],
        color: "from-emerald-500 to-teal-500",
        badge: "Disponible pronto",
        href: "/servicios#asesores-financieros",
        icon: "finance",
        cta: "Recibir asesoría",
        languages: ["Español", "Inglés", "Francés"]
      },
      {
        id: 5,
        name: "Asesores Inmobiliarios",
        description: "Agentes inmobiliarios que te ayudan a comprar, vender o rentar con acompañamiento transparente.",
        subservices: ["Compra", "Renta", "Comercial"],
      ...
      {
        id: 6,
        name: "Giros Internacionales",
        description: "Envíos de dinero seguros y rápidos para apoyar a tu familia desde Canadá.",
        subservices: ["Remesas", "Transferencias", "Cambio"],
      ...
      {
        id: 7,
        name: "Asesores de carros",
        description: "Venta, compra y financiamiento de vehículos con acompañamiento confiable.",
        subservices: ["Compra", "Venta", "Financiamiento"],
      ...
      },
      {
        ...
        description: "Barberos, estilistas y manicuristas latinos cerca de ti.",
        subservices: ["Barberos", "Estilistas", "Manicuristas"],
        color: "from-rose-500 to-pink-500",
        badge: "Disponible bajo cita",
      ...
      },
      {
        id: 9,
        name: "Traductores",
        description: "Traductores certificados para documentos oficiales y trámites.",
        subservices: ["Oficiales", "Interpretación", "Documentos"],
        color: "from-slate-700 to-emerald-600",
        badge: "Respuesta rápida",
        href: "/servicios#traductores",
        icon: "translation",
        cta: "Solicitar traducción",
        languages: ["Español", "Inglés", "Francés"]
      }
    ]
  },
  auth: {
    ...
    passwordMin8: "La contraseña debe tener al menos 8 caracteres, una letra y un número",
    ...
    verifyEmailMissing: "Falta el correo para verificar la cuenta.",
  ...
  catalog: {
    ...
    restaurantBanner: {
      ...
      backToRestaurants: "Volver a Comidas"
    },
    // ProductCard
    productCard: {
    ...
    productList: {
      ...
      noResultsFor: "No se encontraron productos para \"{search}\"",
  ...
  cart: {
    ...
    error: {
      ...
      description: "Ocurrió un problema al cargar tu carrito. Intenta de nuevo.",
      retry: "Intentar de nuevo",
      reload: "Recargar página",
      details: "Detalles del error (desarrollo)"
    },
    categories: {
      productos: "Productos",
      comidas: "Comidas",
    ...
    delivery: {
      ...
      applying: "Aplicando...",
      addressRequired: "Agrega una dirección para confirmar la entrega.",
    ...
    success: {
      ...
      addressAdded: "Dirección agregada. Actualizando carrito..."
    },
    promotions: {
      maisonPoulet: {
    ...
    errors: {
      ...
      notDeliverable: "No disponible esta ubicación por el momento.",
      addressNotReady: "La dirección no está lista aún. Intenta en unos segundos.",
      addressVerifyFailed: "Error verificando la dirección. Intenta de nuevo.",
      checkoutFailed: "Error procesando el pago. Intenta de nuevo.",
      couponWithMessage: "Error con el cupón: {message}"
    },
    nonTaxable: "Sin impuestos",
    variationDetails: {
  ...
  orders: {
    ...
    detail: {
      ...
      loading: "Cargando detalles del pedido...",
      loadError: "No se pudo cargar este pedido",
      notFound: "Pedido no encontrado",
      notFoundDesc: "El pedido no existe o no tienes acceso a él.",
      ...
      downloadInvoiceBtn: "Descargar factura",
      contactSupport: "Contactar soporte",
      cancelOrderBtn: "Cancelar pedido",
      notes: "Notas del pedido",
      noteDelivery: "Entrega",
      noteCoupon: "Cupón",
      noteShippingInfo: "Envío",
      noteMethod: "Método",
      noteCode: "Código",
      noteType: "Tipo",
      noteShippingSavings: "Ahorro en envío",
      noteShippingCost: "Costo de envío",
      noteDoor: "Puerta",
      noteFreeShipping: "Envío gratis",
      noteFreeShippingCoupon: "Envío gratis aplicado por cupón"
    }
  },
  ...
  addresses: {
    ...
    selector: {
      ...
      firstCreated: "Primera dirección creada y seleccionada. Ya puedes pagar.",
  ...
  servicesPage: {
    ...
    heroSubtitle: "Abogados, médicos, contadores, asesores y traductores bilingües para la comunidad latina en Montreal.",
    heroBadge: "Disponibles muy pronto",
    heroCta: "Conoce a los profesionales",
    comingSoon: "Lanzamiento muy pronto",
    description: "Conecta con especialistas legales, médicos, financieros, inmobiliarios, automotrices y de traducción que hablan tu idioma y entienden tu cultura.",
    highlightsTitle: "Profesiones destacadas",
    highlightsSubtitle: "Elige la categoría que necesitas y te avisaremos cuando habilitemos agendas y consultas.",
    contactTitle: "¿Necesitas otro profesional?",
    contactDescription: "Cuéntanos tu caso y te conectaremos con el experto indicado o abriremos la categoría.",
    ...
    landing: {
      ...
      pricing: {
        ...
        max: {
          ...
          f3: "Galería de proyectos (Próximamente)",
          f4: "Redes sociales ilimitadas",
          f5: "Estadísticas avanzadas"
        }
      },
      testimonials: {
    ...
    pricingPage: {
      ...
      plans: {
        ...
        max: {
          ...
          f4: "Galería de proyectos (Próximamente)",
